...
public class CirculoEscalavel implements ObjetoGeometrico,Escalavel {
	...
	public CirculoEscalavel(Ponto _centro, double _raio) {
		this.setCentro(_centro); // Note o uso da palavra-chave this para marcar os campos
		this.setRaio(_raio);	// da classe que tem o mesmo nome dos argumentos
	}
	...
	public void setCentro(Ponto _centro) {
		this.centro = _centro;
	}
	...
	public ObjetoGeometrico clona() throws Exception {
		CirculoEscalavel clone = new CirculoEscalavel(this.getCentro(), this.getRaio());
		return clone;
	}
